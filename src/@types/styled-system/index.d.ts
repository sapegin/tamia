...
declare module 'styled-system' {
	...
	export interface LowLevelSystemfunctionArguments<N, S> {
		property?: string;
		properties?: string[];
		scale?: string;
		transform?: (n: N, scale?: S) => any;
		defaultScale?: S;
	}

	export function system<N = string | number, S = Scale>(
		// tslint:disable-next-line no-unnecessary-generics
		args: { [prop: string]: LowLevelSystemfunctionArguments<N, S> }
	): { [cssProp: string]: string };
